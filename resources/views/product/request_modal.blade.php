...
<div class="modal fade" id="productRequestModal" tabindex="-1" aria-labelledby="productRequestModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="productRequestForm" action="{{ route('product.storeRequest') }}" method="POST"
                ...
                <div class="modal-body">
                    ...
                    @if(isset($uploaded_image_path))
                        ...
                        <div class="mb-3">
                            ...
                            @if(isset($uploaded_image_path))
                                <img src="{{ asset('storage/' . $uploaded_image_path) . '?t=' . time() }}"
                                     alt="Uploaded Image" class="img-fluid rounded mb-2" style="max-height: 150px;">
